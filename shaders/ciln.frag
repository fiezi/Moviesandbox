...
void main(){
    ...
    objColor.a=1.0;
     ...
     if (int(gl_FragCoord.x+gl_FragCoord.y)%8<2){
        gl_FragData[0].g*=1.5;
     }else if (int(gl_FragCoord.x-gl_FragCoord.y)%8>5){
        gl_FragData[0].r*=2.5;
     }else{
        gl_FragData[0].r=(gl_FragData[0].r+gl_FragData[0].g+gl_FragData[0].b)/2.0;
        gl_FragData[0].g=(gl_FragData[0].r+gl_FragData[0].g+gl_FragData[0].b)/2.0;
        gl_FragData[0].b=(gl_FragData[0].r+gl_FragData[0].g+gl_FragData[0].b)/2.0;
     }
